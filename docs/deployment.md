...
| `HETCHY_PUBLIC_BASE_URL` | Externally reachable app origin used for sandbox callbacks and generated links; defaults to an external `LOGOUT_RETURN_TO`, then the WorkOS/Slack callback origin, then `http://localhost:$WEB_PORT` |
