...
require (
	...
	github.com/daytonaio/daytona/libs/toolbox-api-client-go v0.182.0
	...
	github.com/sleuth-io/sx v1.3.3
...
require (
	...
	github.com/daytonaio/daytona/libs/api-client-go v0.182.0 // indirect
